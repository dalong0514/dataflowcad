...
(defun GetGsComfortAirPropertyChNameList ()
  '("房间编号" "房间名称" "房间吊顶高度" "房间面积" "防爆等级" "生产类别" "工作班数" "每班操作人数" "房间夏季温度" "房间冬季温度" "房间夏季相对湿度" "房间冬季相对湿度" "发热设备表面积" "发热设备表面温度" "设备发热量" "设备同时运转电机总功率" "有害气体或或灰尘名称" "有害气体或或灰尘名数量" "散湿量" "事故排风设备位号" "正负压要求" "备注")
)
