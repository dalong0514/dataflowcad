...
(defun InsertBsGCTOneEquipNozzle (insPt barrelRadius newBarrelHalfHeight thickNess dataType drawFrameScale oneEquipNozzleDictData straightEdgeHeight / 
...
(defun GenerateUpEllipseHeadNozzle (insPt barrelRadius dataType thickNess drawFrameScale upLeftNozzleDictData upRightNozzleDictData /) 
  (if (/= upLeftNozzleDictData nil) 
    (GenerateUpLeftHeadNozzle insPt barrelRadius dataType upLeftNozzleDictData drawFrameScale)
  )
  (if (/= upRightNozzleDictData nil) 
    (GenerateUpRightHeadNozzle insPt barrelRadius dataType upRightNozzleDictData drawFrameScale)
  )
)
...
(defun GenerateDownEllipseHeadNozzle (insPt barrelRadius dataType thickNess drawFrameScale downLeftNozzleDictData downRightNozzleDictData /) 
  (if (/= downLeftNozzleDictData nil) 
    (GenerateDownLeftHeadNozzle insPt barrelRadius dataType downLeftNozzleDictData drawFrameScale)
  )
  (if (/= downRightNozzleDictData nil) 
    (GenerateDownRightHeadNozzle insPt barrelRadius dataType downRightNozzleDictData drawFrameScale)
  )
)

; 2021-07-15
(defun GenerateSideRightNozzle (insPt barrelRadius equipTag sideLeftNozzleDictData drawFrameScale /) 
...
; 2021-07-15
(defun GenerateSideLeftNozzle (insPt barrelRadius equipTag sideLeftNozzleDictData drawFrameScale /) 
  (if (IsNozzleOffsetAllNull sideLeftNozzleDictData) 
    (InsertBlockByRotateUtils insPt "BsGCTGraphNozzle" "0DataFlow-BsThickLine" (list (cons 0 dataType)) (/ PI 2))
...
; 2021-07-14
(defun GenerateUpLeftHeadNozzle (insPt barrelRadius equipTag upLeftNozzleDictData drawFrameScale /) 
  (if (IsNozzleOffsetAllNull upLeftNozzleDictData) 
    ...
    (GenerateOneUpLeftHeadNozzle insPt barrelRadius equipTag upLeftNozzleDictData drawFrameScale)
  )
)

; 2021-07-14
(defun GenerateUpRightHeadNozzle (insPt barrelRadius equipTag upRightNozzleDictData drawFrameScale /) 
...
; 2021-07-14
(defun GenerateDownLeftHeadNozzle (insPt barrelRadius equipTag downLeftNozzleDictData drawFrameScale /) 
...
; 2021-07-14
(defun GenerateDownRightHeadNozzle (insPt barrelRadius equipTag downRightNozzleDictData drawFrameScale /) 
...
(defun GenerateOneUpLeftHeadNozzle (insPt barrelRadius equipTag upLeftNozzleDictData drawFrameScale / nozzlePositionRadius yOffset nozzleInsPt nozzleLeftInsPt) 
  ; (setq *GCTTotalHeightInsptList* nil) ;; the key for solve a red hat 2021-07-16 
  (mapcar '(lambda (x) 
...
; 2021-07-16
(defun InsertBsGCTOneEquipTotalHeightDimension (insPt barrelHalfHeight straightEdgeHeight barrelRadius thickNess legSupportHeight drawFrameScale / firstInsPt lastInsPt) 
  ...
  (InsertBsGCTVerticalRotatedDimension drawFrameScale 
    firstInsPt
    lastInsPt
    (MoveInsertPositionUtils insPt (+ barrelRadius thickNess 350) (GetNegativeNumberUtils (GetXHalfDistanceForTwoPoint firstInsPt lastInsPt))) 
    "")
...
(defun InsertBsGCTReactorGraphy (insPt barrelRadius barrelHalfHeight thickNess headThickNess dataType straightEdgeHeight 
  ...
  ; refactored at 2021-07-14
  (InsertBsGCTOneEquipNozzle insPt barrelRadius newBarrelHalfHeight thickNess dataType drawFrameScale oneEquipNozzleDictData straightEdgeHeight)
...
(defun InsertBsGCTVerticalTankGraphy (insPt barrelRadius barrelHalfHeight thickNess headThickNess dataType straightEdgeHeight 
  ...
  ;; refactored at 2021-07-17
  (InsertBsGCTOneEquipGlobalDimension insPt barrelHalfHeight straightEdgeHeight barrelRadius thickNess drawFrameScale)
  (InsertBsGCTOneEquipTotalHeightDimension insPt barrelHalfHeight straightEdgeHeight barrelRadius thickNess legSupportHeight drawFrameScale)
)
