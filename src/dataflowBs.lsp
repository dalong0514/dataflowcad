...
(defun GetOneEquipUpLeftHeadNozzleDictData (oneEquipNozzleDictData /)
  (vl-remove-if-not '(lambda (x) 
                       (and (= (GetDottedPairValueUtils "POSITION" x) "罐顶" ) (= (GetDottedPairValueUtils "LEFT_RIGHT" x) "左侧" ))
                    ) 
...
(defun GetOneEquipUpRightHeadNozzleDictData (oneEquipNozzleDictData /)
  (vl-remove-if-not '(lambda (x) 
                       (and (= (GetDottedPairValueUtils "POSITION" x) "罐顶" ) (= (GetDottedPairValueUtils "LEFT_RIGHT" x) "右侧" ))
                    ) 
    oneEquipNozzleDictData
  )
)
...
(defun GetOneEquipDownLeftHeadNozzleDictData (oneEquipNozzleDictData /)
  (vl-remove-if-not '(lambda (x) 
                       (and (= (GetDottedPairValueUtils "POSITION" x) "罐底" ) (= (GetDottedPairValueUtils "LEFT_RIGHT" x) "左侧" ))
                    ) 
    oneEquipNozzleDictData
  )
)
...
(defun GetOneEquipDownRightHeadNozzleDictData (oneEquipNozzleDictData /)
  (vl-remove-if-not '(lambda (x) 
                       (and (= (GetDottedPairValueUtils "POSITION" x) "罐底" ) (= (GetDottedPairValueUtils "LEFT_RIGHT" x) "右侧" ))
                    ) 
    oneEquipNozzleDictData
  )
)
...
(defun GetOneEquipSideLeftNozzleDictData (oneEquipNozzleDictData /)
  (vl-remove-if-not '(lambda (x) 
                       (and (= (GetDottedPairValueUtils "POSITION" x) "罐壁" ) (= (GetDottedPairValueUtils "LEFT_RIGHT" x) "左侧" ))
                    ) 
    oneEquipNozzleDictData
  )
)
...
(defun GetOneEquipSideRightNozzleDictData (oneEquipNozzleDictData /)
  (vl-remove-if-not '(lambda (x) 
                       (and (= (GetDottedPairValueUtils "POSITION" x) "罐壁" ) (= (GetDottedPairValueUtils "LEFT_RIGHT" x) "右侧" ))
                    ) 
    oneEquipNozzleDictData
  )
)
