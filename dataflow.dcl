...
filterAndModifyPropertyBox : dialog {
  label = "天正设计流数据一体化V1.4———批量修改数据强化版"; 
...
modifyBlockPropertyBox : dialog {
  label = "天正设计流数据一体化V1.4———批量修改通用块数据"; 
...
generatePublicProcessElementBox : dialog {
  label = "天正设计流数据一体化V1.4———自动生成单回路辅助流程组件"; 
...
numberDrawNumBox : dialog {
  label = "天正设计流数据一体化V1.4———批量编图签流程图号"; 
  key = "numberDrawNum";
  : boxed_radio_column {
    key = "modifyBox";
    width = 80;
