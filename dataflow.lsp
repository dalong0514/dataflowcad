...
(defun c:printVersionInfo (/ versionInfo)
  (setq versionInfo "最新版本号 V1.1，更新时间：2020-11-04")
...
(defun ExportInstrumentData (fileName / fileDir)
  ...
  (WriteDataListToFileUtils fileDir (append (ExtractInstrumentToJsonList "InstrumentP")
                                            ...
                                            (ExtractEquipmentToJsonList "Pump")
                                            (ExtractEquipmentToJsonList "Vacuum")
                                            (ExtractEquipmentToJsonList "Centrifuge")
                                            (ExtractEquipmentToJsonList "CustomEquip")
                                    )
  )
)
...
(defun ExportElectricData (fileName / fileDir)
  (setq fileDir (GetExportDataFileDir fileName))
  (WriteDataListToFileUtils fileDir (append (ExtractEquipmentToJsonList "Reactor")
                                            ;(ExtractEquipmentToJsonList "Tank")
                                            (ExtractEquipmentToJsonList "Pump")
